...
export const useGetStudentCohorts = () => {
  return useQuery({
    queryKey: ['studentCohorts'],
    queryFn: getStudentCohortsService,
    staleTime: Infinity,
    refetchInterval: false,
  });
};
